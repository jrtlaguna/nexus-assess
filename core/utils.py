...
def get_base_email_vars():
    vars = {}
    logo_url = f"{settings.BACKEND_URL}{static('images/logo.png')}"
    top_line_art_url = f"{settings.BACKEND_URL}{static('extras/top_line_art.png')}"
    bottom_line_art_url = (
        f"{settings.BACKEND_URL}{static('extras/bottom_line_art.png')}"
    )

    vars.update(
        {
            "logo": logo_url,
            "top_line_art_url": top_line_art_url,
            "bottom_line_art_url": bottom_line_art_url,
        }
    )
    return vars
